/**
 * Local fallback dataset used when VITE_USE_FALLBACK_DATA="true" and the
 * Laravel API is unreachable. Lets the UI work in dev / preview without
 * a backend running. Remove once your Laravel API is live.
 */
...
const SAMPLE_GLB = "https://modelviewer.dev/shared-assets/models/Chair.glb";
const SAMPLE_GLB_2 =
  "https://modelviewer.dev/shared-assets/models/glTF-Sample-Models/2.0/AntiqueCamera/glTF-Binary/AntiqueCamera.glb";
const SAMPLE_USDZ = "https://modelviewer.dev/shared-assets/models/Chair.usdz";
...
export const fallbackCategories: Category[] = ["Sofa", "Chair", "Table", "Bed"];
